  ...
  return (
    <>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        {/* Table Headings */}
        <div className="grid grid-cols-12 border-t border-stroke p-3 dark:border-strokedark md:px-6 2xl:px-7.5 bg-gray-100 dark:bg-gray-800 font-medium text-black dark:text-white">
        ...
        {data.map((item, index) => (
          <div
            key={index}
            className="grid grid-cols-12 border-t border-stroke py-4 px-4 dark:border-strokedark md:px-6 2xl:px-7.5 text-black dark:text-white"
          >
