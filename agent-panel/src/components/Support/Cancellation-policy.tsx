  ...
  return (
    <>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-md dark:border-strokedark dark:bg-boxdark">
        ...
        {/* Table Headers */}
        <div className="grid grid-cols-8 border-t border-stroke p-3 dark:border-strokedark bg-gray-100 dark:bg-gray-800 font-medium text-black dark:text-white">
        ...
        {cancellationData.map((item, index) => (
          <div
            key={index}
            className="grid grid-cols-8 border-t border-stroke py-4 px-4 dark:border-strokedark text-black dark:text-white"
          >
