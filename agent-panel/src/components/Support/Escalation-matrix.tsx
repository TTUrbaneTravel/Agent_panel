    ...
    <>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="py-6 px-4 md:px-6 xl:px-7.5">
          <h3 className="font-medium text-black dark:text-white">Escalation Matrix</h3>
        </div>
        ...
        <div className="grid grid-cols-6 sm:grid-cols-8 border-t border-stroke py-4 px-4 dark:border-strokedark md:px-6 2xl:px-7.5 bg-gray-800">
          <div className="col-span-2 font-medium text-black dark:text-white">Support Type</div>
          <div className="col-span-2 font-medium text-black dark:text-white">Email Id</div>
          <div className="col-span-2 font-medium text-black dark:text-white">Phone No.</div>
        </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="col-span-2 text-sm text-black dark:text-white">{item.supportType}</div>
            <div className="col-span-2 text-sm text-black dark:text-white">{item.email}</div>
            <div className="col-span-2 text-sm text-black dark:text-white">{item.phone}</div>
          </div>
        ))}
      </div>
    </>
